...
public class ApplyTemplateTest {
	...
	public void testEvaluateSimple() throws Exception {
		...
		String result = template.evaluate(new TemplateInterpreter(), scope, asList(var("name", string("template")))).getText();
	...
	public void testEvaluateWithArguments() throws Exception {
		...
		String result = template.evaluate(new TemplateInterpreter(), scope, asList(var("name", string("template")), var("arguments", map(var("argument",string("value")))))).getText();
	...
	public void testEvaluateNoName() throws Exception {
		...
		template.evaluate(new TemplateInterpreter(), scope, emptyList()).getText();
	}
	...
	public void testEvaluateNoStringName() throws Exception {
		...
		TemplateImmediateExpression result = template.evaluate(new TemplateInterpreter(), scope, asList(var("name", BooleanLiteral.TRUE)));
	...
	public void testEvaluateNoParent() throws Exception {
		...
		TemplateImmediateExpression result = template.evaluate(new TemplateInterpreter(), null, asList(var("name", string("template"))));
	...
	public void testEvaluateNoTemplateToResolve() throws Exception {
		...
		TemplateImmediateExpression result = template.evaluate(new TemplateInterpreter(), scope, asList(var("name", string("template"))));
